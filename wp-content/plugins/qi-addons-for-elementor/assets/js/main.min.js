! function(d) {
    ...
    window.qodefAddonsCore = {}, qodefAddonsCore.shortcodes = {}, qodefAddonsCore.body = d("body"), qodefAddonsCore.html = d("html"), qodefAddonsCore.windowWidth = d(window).width(), qodefAddonsCore.windowHeight = d(window).height(), qodefAddonsCore.scroll = 0, d(document).ready(function() {
        qodefAddonsCore.scroll = d(window).scrollTop(), i.init(), S.init(), e.init()
    ...
    var S = {
            ...
            getOptions: function(e) {
                var o = void 0 !== e.data("options") ? e.data("options") : {},
                    ...
                    q = (!1 !== u && 5e3 !== q ? u = {
                        ...
                        disableOnInteraction: !1
                    }), void 0 !== o.slidesPerView1680 && "" !== o.slidesPerView1680 ? parseInt(o.slidesPerView1680, 10) + n : "auto" === o.slidesPerView ? "auto" : 5 + n),
                    b = void 0 !== o.slidesPerView1440 && "" !== o.slidesPerView1440 ? parseInt(o.slidesPerView1440, 10) + n : "auto" === o.slidesPerView ? "auto" : 5 + n,
                    C = void 0 !== o.slidesPerView1366 && "" !== o.slidesPerView1366 ? parseInt(o.slidesPerView1366, 10) + n : "auto" === o.slidesPerView ? "auto" : 4 + n,
                    y = void 0 !== o.slidesPerView1024 && "" !== o.slidesPerView1024 ? parseInt(o.slidesPerView1024, 10) + n : "auto" === o.slidesPerView ? "auto" : 3 + n,
                    A = void 0 !== o.slidesPerView768 && "" !== o.slidesPerView768 ? parseInt(o.slidesPerView768, 10) + n : "auto" === o.slidesPerView ? "auto" : 2 + n,
                    I = void 0 !== o.slidesPerView680 && "" !== o.slidesPerView680 ? parseInt(o.slidesPerView680, 10) + n : "auto" === o.slidesPerView ? "auto" : 1 + n,
                    x = void 0 !== o.slidesPerView480 && "" !== o.slidesPerView480 ? parseInt(o.slidesPerView480, 10) + n : "auto" === o.slidesPerView ? "auto" : 1 + n;
                if (m || (s < 2 ? A = y = C = b = q = s : s < 3 ? y = C = b = q = s : s < 4 ? C = b = q = s : s < 5 && (b = q = s)), "never" !== i) switch (i) {
                    case 1024:
                        y = Math.floor(y);
                    case 768:
                        A = Math.floor(A);
        ...
        e = (qodefAddonsCore.qodefSwiper = S, "function" != typeof Object.assign && (Object.assign = function(e) {
            ...
            init: function() {
                if (this.holder = d(".qodef-qi-fslightbox-popup"), this.holder.length) {
                    ...
                    for (const n in fsLightboxInstances) fsLightboxInstances[n].props.onInit = function() {
    ...
    var e = {
        ...
        initItem: function(n) {
            n.find(".qodef-e-word-holder").each(function() {
                for (var e = i(this).text(), o = e.length, t = "", n = 0; n < o; n++) t += '<span class="qodef-e-character">' + e.charAt(n) + "</span>";
                i(this).html(t)
...
function(d) {
    "use strict";
    qodefAddonsCore.shortcodes.qi_addons_for_elementor_cards_gallery = {}, d(document).ready(function() {
        e.init()
    });
    var e = {
        init: function() {
            this.holder = d(".qodef-qi-cards-gallery"), this.holder.length && this.holder.each(function() {
                e.initItem(d(this))
            })
        },
        initItem: function(o) {
            var t, n = o.find(".qodef-m-card"),
            ...
            d(n.get().reverse()).each(function() {
                var e = d(this);
                e.on("click", function() {
                    if (!n.last().is(e)) return "both" === i && (t = e.index() % 2 ? "0 0 0 20%" : "0 0 0 -20%"), e.addClass("qodef-out").animate({
                        margin: t
                    }, 200, "swing", function() {
    ...
    var s = {
        ...
        isInView: function(o) {
            new IntersectionObserver(function(e) {
                ...
                threshold: [.15]
            }).observe(o[0]), document.addEventListener("visibilitychange", function() {
    ...
    var o = {
        ...
        initSwiperReinit: function(e) {
            var o, t = e.find(".qodef-m-main-slider > .qodef-qi-swiper-container .swiper-slide-active"),
                ...
                s = (i[0].swiper.autoplay.stop(), d[0].swiper.destroy(), r[0].swiper.destroy(), new Swiper(d[0], Object.assign(t))),
...
function(e) {
    ...
    var o = {
        ...
        initItem: function(s) {
            qodefAddonsCore.shortcodes.qi_addons_for_elementor_button.qodefButton.init(s), e("body").on("added_to_cart", function() {
                var e = s.find(".added_to_cart:not(.qodef-qi-button)");
                if (e.length) {
                    for (var o = e.siblings(".add_to_cart_button"), t = ["button", "product_type_simple", "add_to_cart_button", "ajax_add_to_cart", "added"], n = t.length, i = o.attr("class"), d = o.find(".qodef-m-border"), r = o.find(".qodef-m-inner-border"), o = o.find(".qodef-m-icon"), a = 0; a < n; a++) i = i.replace(t[a], "");
                    e.addClass(i), e.wrapInner('<span class="qodef-m-text">'), d.length && (d = d.clone(), e.append(d)), o.length && (d = o.clone(), e.append(d)), r.length && (o = r.clone(), e.append(o))
                }
            })
        }
    };
